...
|--------------|-------------|-----------------|
| Biodiversity Project| Analyze National Park Servie data for 4 parks within 7 days, understanding the Conservation Satus of species and number of observation at each park | Python |
| Website_Traffic_Project| Fictional website traffic data, understanding conversion rate and time from visit to purchase | Python |
...
- Data Cleaning, EDA and visualization using R.
